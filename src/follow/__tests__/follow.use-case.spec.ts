...
import { FollowUseCase } from '../use-cases';
...
describe('FollowUseService', () => {
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<FollowUseCase>(FollowUseCase);
  ...
  it('should thow an BadRequestException if username is the same as followedBy', async () => {
  ...
  it('should thow an NotFoundException if user is not found', async () => {
